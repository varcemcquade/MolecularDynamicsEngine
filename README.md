...
Configuring nvcc and CUDA Toolkit have proven to be a non-trivial task. This is not a vim resignation -- I've simply offloaded compilation and execution woes onto VS Code for this project. 
